...
namespace CleanArchitecture.Infrastructure.Migrations
{
    ...
    [Migration("20250711143554_OutboxCreationMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Roles.RolPermission", b =>
                {
                    ...
                    b.HasKey("RoleId", "PermissionId")
                        .HasName("pk_rol_permissions");

                    b.HasIndex("PermissionId")
                        .HasDatabaseName("ix_rol_permissions_permission_id");

                    b.ToTable("rol_permissions", (string)null);
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Roles.RolPermission", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.Permissions.Permission", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_rol_permissions_permissions_permissions_id");
                    ...
                    b.HasOne("CleanArchitecture.Domain.Roles.Role", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_rol_permissions_roles_role_id");
                });
